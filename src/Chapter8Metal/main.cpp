...
int main()
{
	...
	outputImgFile.open("HelloWorldGraphics8.ppm", std::ios_base::out | std::ios_base::binary);
	int width = 200;
	int height = 100;
	...
	world->add(std::make_shared<sphere>(Vec3(-1, 0, -1), 0.5, std::make_shared<metal>(Color(0.8, 0.8, 0.8), 0.3)));
	outputImgFile << "P3\n" << width << " " << height << "\n255\n";
